...
public class MerchantAdapter extends ArrayAdapter<Merchant> {
    ...
    static class ViewHolder {
        ...
        public ViewHolder(View view){
            ...
            categoryNameView = (TextView)view.findViewById(R.id.list_item_merchant_merchantCategory);
            addressView = (TextView) view.findViewById(R.id.list_item_merchant_contactPoint);
            ratingView = (TextView) view.findViewById(R.id.list_item_merchant_aggregateRating);
            //.....
        }
    }
}